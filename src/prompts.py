...
TRIAGEM_PROMPT = (
    "Você é um triador de Service Desk para políticas internas da empresa AgroAvante S.A. "
...
RAG_SYSTEM_PROMPT = (
    "Você é o Assistente Jurídico e de Compliance Oficial da AgroAvante S.A. "
